...
public class CharacterB : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        if ((Input.GetKey(KeyCode.A) || Input.GetKey(KeyCode.D)) && isIce)
        {
        ...
        xInput1 = Input.GetKey(KeyCode.A) ? -1 :
            Input.GetKey(KeyCode.D) ? 1 : 0;

        transform.Translate(xInput1 * moveSpeed, yInput1 * moveSpeed, 0);
        ...
        if ((isIce || isIce1 || isIce2) && xInput1 == 0)
        {
            rb2d.AddForce(oldVelocity);
            oldVelocity = new Vector2(moveSpeed * xInput1, rb2d.velocity.y);
            //rb2d.velocity = new Vector2(oldVelocity.x/2, rb2d.velocity.y);

        }
        
        else if ((isIce || isIce1 || isIce2) && xInput1 != 0)
        {
            rb2d.velocity = new Vector2(moveSpeed * xInput1*25, rb2d.velocity.y);
    ...
    { 
        ...
        currentHealth -= coef; 
        if(currentHealth <= 0) SceneManager.LoadScene("AstroDeathScene"); 
    ...
    void PlatformerMove()
    {
        rb2d.velocity = new Vector2(moveSpeed * xInput1, rb2d.velocity.y);
        oldVelocity = rb2d.velocity;
    }
